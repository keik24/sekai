...
export const INTEL_HOTSPOTS: Hotspot[] = [
  ...
  // Japan regional hotspots (for japan variant)
  {
    id: 'jp_hokkaido',
    name: '北海道',
    subtext: '北海道・東北',
    ...
    lon: 141.35,
    location: '北海道',
    keywords: ['北海道', '札幌', '函館', '旭川', '釧路', '帯広', '苫小牧', 'hokkaido', 'sapporo'],
    description: '北海道地域のニュース・災害情報',
    status: 'Monitoring',
  },
  {
    id: 'jp_tohoku',
    ...
    lat: 38.27,
    lon: 140.87,
    location: '東北地方（宮城・福島・岩手・青森・秋田・山形）',
    keywords: ['東北', '仙台', '福島', '青森', '盛岡', '秋田', '山形', '岩手', '宮城', 'sendai', 'tohoku'],
    description: '東北地方のニュース・災害情報',
    status: 'Monitoring',
  },
  {
    id: 'jp_kanto',
    ...
    lat: 35.69,
    lon: 139.69,
    location: '関東地方（東京・神奈川・埼玉・千葉・茨城・栃木・群馬）',
    keywords: ['東京', '横浜', '川崎', '千葉', '埼玉', 'さいたま', '新宿', '渋谷', '池袋', '品川', '銀座', '国会', '霞が関', '永田町', '首都圏', '関東', 'tokyo', 'yokohama'],
    description: '首都圏のニュース・政治・経済',
    status: 'Monitoring',
  },
  {
    id: 'jp_chubu',
    ...
    lat: 35.18,
    lon: 136.91,
    location: '中部地方（愛知・静岡・新潟・長野・富山・石川・福井・岐阜・山梨）',
    keywords: ['名古屋', '愛知', '静岡', '新潟', '長野', '富山', '石川', '金沢', '福井', '岐阜', 'nagoya'],
    description: '中部地方のニュース・災害情報',
    status: 'Monitoring',
  },
  {
    id: 'jp_kansai',
    ...
    lat: 34.69,
    lon: 135.50,
    location: '関西地方（大阪・京都・兵庫・奈良・滋賀・和歌山・三重）',
    keywords: ['大阪', '京都', '神戸', '兵庫', '奈良', '関西', '近畿', '滋賀', '和歌山', 'osaka', 'kyoto', 'kobe', 'kansai'],
    description: '関西地方のニュース・経済',
    status: 'Monitoring',
  },
  {
    id: 'jp_chugoku',
    ...
    lat: 34.39,
    lon: 132.46,
    location: '中国・四国地方（広島・岡山・山口・鳥取・島根・香川・愛媛・高知・徳島）',
    keywords: ['広島', '岡山', '山口', '鳥取', '島根', '香川', '愛媛', '高知', '徳島', '四国', 'hiroshima'],
    description: '中国・四国地方のニュース・災害情報',
    status: 'Monitoring',
  },
  {
    id: 'jp_kyushu',
    ...
    lat: 33.59,
    lon: 130.40,
    location: '九州地方（福岡・熊本・長崎・鹿児島・大分・佐賀・宮崎）',
    keywords: ['福岡', '博多', '熊本', '長崎', '鹿児島', '大分', '佐賀', '宮崎', '九州', 'fukuoka'],
    description: '九州地方のニュース・災害情報',
    status: 'Monitoring',
  },
  {
    id: 'jp_okinawa',
    ...
    lon: 127.81,
    location: '沖縄県',
    keywords: ['沖縄', '那覇', '普天間', '辺野古', '嘉手納', '米軍', '琉球', 'okinawa'],
    description: '沖縄のニュース・米軍基地問題',
    status: 'Monitoring',
  },
];
